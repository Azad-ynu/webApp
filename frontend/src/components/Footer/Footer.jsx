    ...
    return (
        <BrowserRouter>
            <MDBFooter color="blue-grey" className="page-footer font-small lighten-5 pt-0">
                <div style={{ backgroundColor: "#52c3dc" }}>
                    <MDBContainer>
                        <MDBRow className="py-4 d-flex align-items-center">
                            <MDBCol md="6" lg="5" className="text-center text-md-left mb-4 mb-md-0">
                                <h6 className="mb-0 " style={{ color: "black" }}> Get connected with me via social networks!</h6>
                            </MDBCol>
                            <MDBCol md="6" lg="7" className="text-center text-md-right">
                                <Link href='https://www.google.com' className="fb-ic ml-0">
                    ...
                    <MDBRow className="mt-3">
                        <MDBCol md="3" lg="3    " xl="3" className="mb-4 dark-grey-text">
                            <h6 className="text-uppercase font-weight-bold">
                                <strong>eAgro电子农业</strong>
                            </h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p>
                                The purpose of this Web Application is to provide connections between different roles in the agriculture industry. As the farmers are not getting a fair price for their goods because of middleman. This app eliminates the requirement of contractors for farmers. Farmers can buy their required needs for farming from Sellers and they can also sell their products to the Consumers
                            </p>
                        </MDBCol>
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" /> Dhaka, Bangladesh</p>
                            <p><i className="fa fa-envelope mr-3" /> akazadrajuedu@gmail.com</p>
                            <p><i className="fa fa-phone mr-3" /> +88 0172-6727464</p>
                            <p><i className="fa fa-print mr-3" /> +88 0172-6727464</p>
                        </MDBCol>
                ...
                <div className="footer-copyright text-center py-3">
                    <MDBContainer fluid>
                        &copy; {new Date().getFullYear()} Undergraduate Thesis Design By: {" "}
                    MD ABUL KALAM AZAD RAJU-YNU
                </MDBContainer>
                </div>
            </MDBFooter>
        </BrowserRouter>
